  ...
  <div class="page">
    ...
    <div class="car-holder">
      <ul>
        ...
        <li>
          <div class="bg-img"><div style="background-image: url(<?php echo $car->getImg(); ?>);"></div></div>
          <div class="info">
            <h3><?php echo $car->make; ?> <?php echo $car->model; ?></h3>
            <hr>
            <p>This car is <?php echo $car->color; ?>, click here for more information! <a href="#" class="tag">Car news</a></p>
          </div>
        </li>
        <?php } ?>
      </ul>      
